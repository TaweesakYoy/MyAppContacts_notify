...
import taweesak.com.myappcontactsnotify.AlarmReceiver;
import taweesak.com.myappcontactsnotify.reminder.DateTimeSorter;
...
public class FragmentReminder extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Setup toolbar
        //setSupportActionBar(mToolbar); ----Old
        ((AppCompatActivity) getActivity()).setSupportActionBar(mToolbar);


        ((AppCompatActivity) getActivity()).setSupportActionBar(mToolbar);
//    mToolbar.setTitle(R.string.app_name);  //--hide#######
// On clicking the floating action button
       /* mAddReminderButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), ReminderAddActivity.class); // MainActivity.class ??????
    ...
    public class SimpleAdapter extends RecyclerView.Adapter<SimpleAdapter.VerticalItemHolder> {
        ...
        public void onBindViewHolder(VerticalItemHolder itemHolder, int position) {
            ...
            itemHolder.setReminderName(item.mName);
            itemHolder.setReminderImage(item.mImage);
        ...
        public class ReminderItem {
            ...
            public ReminderItem(String Title, String DateTime, String Repeat, String RepeatNo, String RepeatType, String Active, String Name,
                                byte[] Image) {
                this.mTitle = Title;
        ...
        public class VerticalItemHolder extends SwappingHolder
            ...
            private TextView mTitleText, mDateAndTimeText, mRepeatInfoText , mName;
            ...
            public VerticalItemHolder(View itemView, SimpleAdapter adapter) {
                ...
                mName = itemView.findViewById(R.id.recycle_name);
            }
            ...
            // Set Image views
            //test$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
            public void setReminderImage(byte[] images) {
                mThumbnailImage.setImageBitmap(BitmapFactory.decodeByteArray(images, 0, images.length));
            }
        ...
        public List<ReminderItem> generateData(int count) {
            ...
            for (Reminder r : reminders) {
                ...
                Names.add(r.getmName());
                // test$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
                Images.add(r.getmImage());
            }
            ...
            for (DateTimeSorter item : DateTimeSortList) {
                ...
                items.add(new SimpleAdapter.ReminderItem(Titles.get(i), DateAndTime.get(i), Repeats.get(i),
                        RepeatNos.get(i), RepeatTypes.get(i), Actives.get(i),Names.get(i),Images.get(i)));
