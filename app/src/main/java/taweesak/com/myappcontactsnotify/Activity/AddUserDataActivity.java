...
public class AddUserDataActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDbUser = new UserDbHelper(this);

        addFirstName = findViewById(R.id.add_first_nameUser);
        addLastName = findViewById(R.id.add_last_nameUser);
        addPhone = findViewById(R.id.add_phoneUser);
        addEmail = findViewById(R.id.add_emailUser);
        addImage = findViewById(R.id.add_imageUser);
        addImage.setImageResource(R.drawable.ic_person);
        addImage.setTag(R.drawable.ic_person);
        favorite = findViewById(R.id.add_favoriteUser);
        addLine = findViewById(R.id.add_lineUser);

        createContact = findViewById(R.id.create_contactUser);
        ...
        createContact.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                boolean isInserted = myDbUser.insertData(
                ...
                if(isInserted == true) {
                    Toast.makeText(AddUserDataActivity.this, "Data Inserted", Toast.LENGTH_LONG).show();
                    Intent myIntent = new Intent(AddUserDataActivity.this, MainActivity.class);
                    AddUserDataActivity.this.startActivity(myIntent);
                    MainActivity.getThemAll();
                    finish();
                }
                else
                    Toast.makeText(AddUserDataActivity.this,"Data not Inserted", Toast.LENGTH_LONG).show();
            }
        });
